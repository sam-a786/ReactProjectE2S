...
class Recommendations extends Component{
    // Hardcoding all the recommendations
    constructor(props){
        super(props)
        this.state = {
            data : [
    ...
    // Rendering the data into a div to act as a way to not 
    // rewrite all the recommendations into seperate divs
    renderData() {
                    ...
                    <div class="carousel">
                        <div class="change_outer">
                            <div class="change_inner">
                                {/* rendering the recommendation divs */}
                                {this.renderData()}
                            </div>
                        </div>
                    </div>
