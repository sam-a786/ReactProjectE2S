...
//modal which takes in 5 arguments first outputs the graph, open and close for the modal
//chosenOption is what we carry thorugh from the KPI-EFC page and same for the 5th
...
//conditional statements to make sure the correct modal is displayed
//e.g. if from the drop down the week option was chosen then we want the week forecast graph and therefore the week modal
  ...
  console.log(choosenOption.value);//making sure the chosen option comes through with the correct value

  //below is the code for what the modal looks like and what it includes, a graph, a download button
  return (
